        ...
        <Container>
          <div className="grid gap-12 md:gap-16 lg:grid-cols-[1fr_360px] items-start">
            <div>
              ...
              <div className="mt-10">
                <div className="text-sm uppercase tracking-[0.16em] font-semibold text-alpine mb-4">Services in {loc.name}</div>
              ...
              {loc.neighborhoods && (
                <div className="mt-10">
                  <div className="text-sm uppercase tracking-[0.16em] font-semibold text-alpine mb-3">Areas we cover</div>
